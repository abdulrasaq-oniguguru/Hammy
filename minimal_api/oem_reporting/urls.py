...
urlpatterns = [
    ...
    # FRONTEND REPORTS
    # ===========================
    # path('dashboard/', views.dashboard, name='dashboard'),  # REMOVED - Not needed
    path('reports/', views.reports_menu, name='reports_menu'),
    # path('reports/bi-dashboard/', views.bi_dashboard, name='bi_dashboard'),  # REMOVED - Not needed
    ...
    # path('reports/performance/', views.performance_analytics, name='performance_analytics'),  # REMOVED - Not needed
    ...
    # DATA SYNC ENDPOINTS
    # ===========================
    path('sync/inventory/', views.sync_inventory_data, name='sync_inventory_data'),
    path('sync/sales/', views.sync_sales_data, name='sync_sales_data'),

    # Full data sync endpoints
    path('sync/products/', views.sync_products_full, name='sync_products_full'),
    path('sync/customers/', views.sync_customers_full, name='sync_customers_full'),
    path('sync/receipts/', views.sync_receipts_full, name='sync_receipts_full'),
